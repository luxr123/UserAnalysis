package com.tracker.coprocessor.utils;
...
public class DoublePriorityQueue<E> {
	...
	private boolean isMaximumHeap = true;
	
	public static void main(String[] args) {
		DoublePriorityQueue<Integer> pq = new DoublePriorityQueue<Integer>(5, false);
	...
	/**
	 * if ${isMaximumHeap} is true, it is maximum heap, else it is minimum heap
	 * @param maxSize
	 * @param isMaximumHeap 
	 */
	@SuppressWarnings("unchecked")
	public DoublePriorityQueue(int maxSize, boolean isMaximumHeap) {
		this.isMaximumHeap = isMaximumHeap;
		size = 0;
