...
insert T_Province(ProName,ProSort,ProRemark) Values('内蒙古','32','自治区');
...
insert T_Province(ProName,ProSort,ProRemark) Values('广西','28','自治区');
insert T_Province(ProName,ProSort,ProRemark) Values('甘肃省','21','省份');
insert T_Province(ProName,ProSort,ProRemark) Values('陕西省','27','省份');
insert T_Province(ProName,ProSort,ProRemark) Values('新疆','31','自治区');
insert T_Province(ProName,ProSort,ProRemark) Values('青海省','26','省份');
insert T_Province(ProName,ProSort,ProRemark) Values('宁夏','30','自治区');
...
insert T_Province(ProName,ProSort,ProRemark) Values('西藏','29','自治区');
insert T_Province(ProName,ProSort,ProRemark) Values('台湾省','7','省份');
insert T_Province(ProName,ProSort,ProRemark) Values('澳门','33','特别行政区');
insert T_Province(ProName,ProSort,ProRemark) Values('香港','34','特别行政区');
insert T_Province(ProName,ProSort,ProRemark) Values('其他','34','省份');
...
INSERT INTO d_geography (country, level, remark) values ('中国', 1, '国');
INSERT INTO d_geography (country, level, remark) values ('其他', 1, '国');


INSERT INTO d_geography (countryId, country, province, level, remark)
	select g.id, g.country, p.ProName , 2 , p.ProRemark from T_Province p , d_geography g where g.country = '中国' and g.level = 1;
INSERT INTO d_geography (countryId, country, province, level, remark)
	select g.id, g.country, '其他', 2, '省份'  from d_geography g where g.country = '其他' and g.level = 1;


INSERT INTO d_geography (countryId, country, provinceId, province, city, level, remark)
	select g.countryId, g.country, g.id, g.province, c.CityName, 3, '市'  from T_City c, T_Province p, d_geography g where c.ProID = p.ProID and p.ProName = g.province;

INSERT INTO d_geography (countryId, country, provinceId, province, city, level, remark)
	select g.countryId, g.country, g.id, g.province, '其他', 3, '市'  from T_Province p, d_geography g where p.ProName = g.province;

INSERT INTO d_geography (countryId, country, provinceId, province, city, level, remark)
	select g.countryId, g.country, g.id, g.province, '其他', 3, '市'  from d_geography g where g.country = '其他' and g.province = '其他' and g.level = 2;	
