 ...
 * 
 * example:
 * OperatingSystem operatingSystem = OperatingSystem.parseUserAgentString("Mozilla/5.0 (Windows NT 6.1; rv:29.0) Gecko/20100101 Firefox/29.0");
...
public enum OperatingSystem {
	...
	MAC_OS_X_Leopard(		Manufacturer.APPLE,OperatingSystem.MAC_OS_X, 101, "Mac Leopard", new String[] { "Mac OS X 10_5" }, null, DeviceType.COMPUTER, null ), // before Mac	
	MAC_OS_X_Snow_Leopard(		Manufacturer.APPLE,OperatingSystem.MAC_OS_X, 102, "Mac Snow Leopard", new String[] { "Mac OS X 10_6"}, null, DeviceType.COMPUTER, null ), // before Mac	
	MAC_OS_X_Lion(		Manufacturer.APPLE,OperatingSystem.MAC_OS_X, 103, "Mac Lion", new String[] { "Mac OS X 10_7"}, null, DeviceType.COMPUTER, null ), // before Mac	
	MAC_OS_X_Mountain_Lion(		Manufacturer.APPLE,OperatingSystem.MAC_OS_X, 104, "Mac Mountain Lion", new String[] { "Mac OS X 10_8"}, null, DeviceType.COMPUTER, null ), // before Mac	
	MAC_OS_X_Mavericks(		Manufacturer.APPLE,OperatingSystem.MAC_OS_X, 105, "Mac Mavericks", new String[] { "Mac OS X 10_9"}, null, DeviceType.COMPUTER, null ), // before Mac	
	...
	public List<OperatingSystem> getChild(){
		return children;
	}
	
	public static List<OperatingSystem> getTopLevelOS(){
