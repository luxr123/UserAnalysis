 ...
 * 
 * example:
 *	UserAgent userAgent = UserAgent.parseUserAgentString("Mozilla/5.0 (Windows NT 6.1; rv:29.0) Gecko/20100101 Firefox/29.0");
 ...
 *
 * 参考 ：https://github.com/HaraldWalker/user-agent-utils
 */
public class UserAgent implements Serializable
{
	...
	{
		Browser browser = Browser.parseUserAgentForChild(userAgentString);
