...
public class WebSiteProvinceStats {
	public final static String SIGN_WEB_PROVINCE = "web-pro"; //基于省份
	...
	//======================================================================省份=========================================================
	public static String generateRow(Integer webId, Integer timeType, String time, Integer visitorType, Integer countryId, Integer provinceId){
		Util.checkNull(countryId);
		Util.checkNull(provinceId);
		return generateRowPrefix(webId, timeType, time, visitorType, countryId) + provinceId;
	}
	
	public static String generateRowPrefix(Integer webId, Integer timeType, String time, Integer visitorType, Integer countryId){
		Util.checkNull(countryId);
		...
		sb.append(SIGN_WEB_PROVINCE).append(RowUtil.ROW_SPLIT);
