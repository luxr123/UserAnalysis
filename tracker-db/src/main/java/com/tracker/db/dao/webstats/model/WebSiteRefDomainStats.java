...
public class WebSiteRefDomainStats {
	public final static String SIGN_WEB_REF_DOMAIN = "web-ref-domain"; //基于外部链接或者外部搜索引擎
	...
	public static final int REF_DOMAIN_INDEX = 6;
	...
	//======================================================================来源域名（外部链接、外部搜索引擎）=========================================================
	public static String generateRow(Integer webId, Integer timeType, String time, Integer visitorType, Integer refType, String domain){
		Util.checkNull(refType);
		return generateRowPrefix(webId, timeType, time, visitorType, refType) + domain;
	}
	
	public static String generateRowPrefix(Integer webId, Integer timeType, String time, Integer visitorType, Integer refType){
		...
		sb.append(SIGN_WEB_REF_DOMAIN).append(RowUtil.ROW_SPLIT);
