...
public class WebSiteDateStats {
	...
	public static String generateRow(Integer webId, Integer timeType, String time, Integer visitorType){
		...
		sb.append(SIGN_WEB_DATE).append(RowUtil.ROW_SPLIT);
		sb.append(visitorType == null ? "":visitorType);
		return sb.toString();
	}
